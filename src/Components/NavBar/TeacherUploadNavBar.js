...
class TeacherUploadNavBar extends React.Component {
    constructor() {
        super()
        this.state = {
            log: true
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <dv className="breadcrumb">
                    <Breadcrumb >
                        ...
                        <Breadcrumb.Item  href='/teacherdashboard'>Subjects</Breadcrumb.Item>
                        <Breadcrumb.Item active href="#">Add Material</Breadcrumb.Item>
...
export default TeacherUploadNavBar;